...
Серед партнерів компанії з ринку FMCG (виробничі та торгові), девелоперського бізнесу, роздрібної торгівлі, ринку ХоРеКа, IT бізнесу та інші.`,
  },
  {
    ...
    description: `Професіонал в побудові та розвитку бізнесу з 25 річним досвідом в українських та іноземній компаніях.\nЕксперт зі стратегічного розвитку, продажам, антикризисного менеджменту, серійний ССО й CEO.
...
6. Побудова та масштабування систем продажів — національні, регіональні та експортні ринки.
7. Формування та розвиток команд, побудова ефективної управлінської структури.
8. Трансформація операційних процесів, автоматизація бізнесу, оптимізація процесів та ланцюгів постачання.
9. Управління P&L,Сash Flow і EBITA
10. Впровадження процесного підходу та систем KPI.
11. Бізнес коучинг`,
  },
  {
    id: 3,
