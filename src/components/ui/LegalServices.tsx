...
const directions = [
  {
    ...
    content: `Складання оферт, договорів, контрактів, угод з контрагентами...
    Аналіз проектів договорів, ведення узгодження умов тощо.`,
  },
  {
    title: 'Юридичний аутсорсинг претензійної роботи',
    content: `Складання претензій контрагентам, аналіз та складання відповідей на претензії,
  ...
  },
  {
    ...
    content: `Підготовка клієнта до податкових перевірок та їх юридичний супровід,
    підготовка відповідей на запити податкових органів.`,
  },
  {
    title: 'Юридичний супровід судового захисту',
    content: `Захист інтересів клієнта в судах всіх юрисдикцій,
    оскарження незаконних рішень податкових та інших органів, представництво у спорах.`,
  },
  {
    title: 'Аутсорсинг бухгалтерського обліку',
    content: `Відновлення бухгалтерського обліку, ведення поточного обліку, підготовка звітності,
    консультації по фінансах та податках.`,
  },
  {
    title: 'Фінансовий консалтинг та бізнес-підтримка',
    content: `Фінансові розслідування, управління фінансовими ресурсами, стратегічне планування,
    розробка бізнес-моделей, KPI, аудит процесів.`,
  },
];
